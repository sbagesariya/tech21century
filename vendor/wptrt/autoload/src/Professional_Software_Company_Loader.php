...
class Professional_Software_Company_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function professional_software_company_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function professional_software_company_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function professional_software_company_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function professional_software_company_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->professional_software_company_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function professional_software_company_load( $class ) {
