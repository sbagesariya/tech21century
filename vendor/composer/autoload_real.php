...
class Professional_Software_Company_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function professional_software_company_loadClassLoader($class)
    {
    ...
    public static function professional_software_company_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
