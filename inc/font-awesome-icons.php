...
/**
 *
 * @package Professional Software Company
 */
if (!function_exists('professional_software_company_font_awesome_icon_array')) {

    function professional_software_company_font_awesome_icon_array() {
